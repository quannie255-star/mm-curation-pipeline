...
**测试基线**：主仓库 129 + 包 29 全绿；ruff check 全绿。任何提交不得低于该基线。
...
- P6 规模扩展（暂缓中，见 ROADMAP）
- INTERVIEW.md 融合 β 新弹药（模板簇语义、union-find 方向 bug、阴性对照归因、Ray 等价性）
...
| 2026-09-03 | 建 DEV_PLAN.md + AGENTS.md 协作入口；tasks.md β 状态对账 | — | 见 git log |
